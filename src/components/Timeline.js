...
export default function Timeline() {
    return (
        <div className='px-3 px-md-5 mx-md-4 mt-5 pt-5'>
            ...
            {/* SANGEET */}
            <div className="row flex-lg-row-reverse align-items-center g-5 py-5 mt-3">
                <div className="col-12 col-sm-8 col-lg-6">
                    <img src={img1} className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" loading="lazy" />
                </div>
            ...
            <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
                <div className="col-12 col-sm-8 col-lg-6">
                    <img src={img2} className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" loading="lazy" />
                </div>
                <div className="col-lg-6 me-auto">
